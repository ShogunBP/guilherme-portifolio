var ROADMAP_TASKS = [
  ...
  },
  {
    ...
    "status": "draft",
    "title": "Decisão de Arquitetura: SSO e URL em Path para Projetos Satélite",
    "area": "active",
    "category": "features",
    "date": "2026-09-05",
    "priority": "média",
    ...
    "summary": "Decisão de arquitetura para SSO entre o painel admin e futuros projetos satélite via path, usando JWT assinado padrão em vez do formato proprietário do NextAuth.",
    "sections": [
      {
        "heading": "Objetivo",
        "content": "Permitir que o dono do portfólio, já logado no `/admin`, acesse projetos satélite futuros (ex: `guilhermemenezes.dev/projects/{slug}`) sem precisar logar novamente, mesmo que esses projetos rodem em containers Docker separados e em stacks tecnológicas distintas.",
        "isEmpty": false
      },
      {
        "heading": "Descrição Funcional",

var ROADMAP_TASKS = [
  {
    ...
    "summary": "Build Docker falhava com SIGSEGV no Alpine devido a runtime edge legado e falta de libc6-compat, sendo mascarado pela falta de set -e no workflow.",
    "sections": [
      {
        "heading": "Descrição",
    ...
    "criteriaSections": [
      {
        "heading": "Validação",
        "content": "> _(preencher após execução e teste)_\n\n- [ ] Bug não reproduz mais\n- [ ] Nenhuma regressão identificada\n- [ ] **Pasta renomeada para `[done]-falha-silenciosa-build-docker-vps-sigsegv` e movida para `archive/bugs/`**",
        "completed": 0,
        "total": 3,
        "isEmpty": false
      }
    ],
    "path": "docs/active/bugs/[ready-for-review]-falha-silenciosa-build-docker-vps-sigsegv"
  },
  {

  ...
  },
  {
    ...
    "sections": [
      ...
      },
      {
        ...
        "content": "SQLite configurado (via `better-sqlite3` ou Prisma com adapter SQLite — decidir durante a execução qual se integra melhor ao restante do stack) com o arquivo `.db` vivendo em um **volume Docker nomeado**, declarado no `docker-compose.yml`, sobrevivendo a recriações do container."
      },
      {
        "heading": "Riscos",

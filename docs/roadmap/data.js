var ROADMAP_TASKS = [
  {
    ...
    "sections": [
      ...
      {
        "heading": "Depende de",
        "content": "Independente dos cards 1 a 4 de 2FA (pode ser executado em paralelo). Depende apenas da autenticação básica já existente (`[done]-login-email-senha`)."
      },
      {
        "heading": "Escopo",
    ...
    "path": "docs/active/features/[approved]-admin-layout-painel"
  },
  {

...
> Validado com testes automatizados E2E locais (test-2fa-card1.ts e test-2fa-integration.ts) e em produção na VPS com build 34417110827 (rotas protegidas retornando 307 e APIs 2FA ativas com 401).

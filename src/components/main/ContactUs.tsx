            ...
            >
              ...
              <div className="space-y-5 text-foreground">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium select-text">guilhermemenezes1337@gmail.com</span>
                  <button
                    onClick={() => copyToClipboard('guilhermemenezes1337@gmail.com', 'Email')}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium select-text">(11) 94888-3857</span>
                  <button
                    onClick={() => copyToClipboard('(11) 94888-3857', 'Phone number')}
                    className="text-muted-foreground hover:text-primary transition"
